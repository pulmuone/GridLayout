...
namespace GridLayout.Views
{
    ...
    public partial class MemberView : ContentPage
    {
        ...
        private async void GridColumnInit()
        {
            ...
            List<Models.GridLayout> _gridColumns = new List<Models.GridLayout>()
            {
                ...
                new Models.GridLayout() {UserID = "admin", MenuCode = _VIEW_NAME, Seq = 6, ColumnCode = "Grade", ColumnName = "Grade", ColumnType = ColumnType.Picker, HorizontalTextAlignment = TextAlignment.Start, Width = 90, IsUse = "Y", CreatedDate = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.ffff"), ModifiedDate = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.ffff") }
            };
            ...
            var dataTemplate = new DataTemplate(() =>
            {
                ...
                //grid.BackgroundColor = Color.FromHex("#598CB5");
        ...
        private void ClosedEvent(bool result)
        {
            if (result)
            {
                GridColumnInit();
